...
As the kaon results are the less affected by the high $x$ drop and also is the most interesting for the community, we ask only the release of kaon related results. The hadron and pion results are too much sensitive due to this high $x$ problem, thus we do not want to ask a release for them yet.
