...
\include{Chapters/Chapter04} % The COMPASS RICH
\include{Chapters/Chapter05} % RICH PID
...
\include{Chapters/Chapter06} % TERAD, RADGEN, DJANGOH
\include{Chapters/Chapter07} % RADGEN issues
\include{Chapters/Chapter08} % Results on Radiative Corrections
\include{Chapters/Chapter09} % Integration of DJANGOH in the Monte-Carlo Chain
...
\include{Chapters/Chapter10} % Determination of 2016 raw multiplicities
\include{Chapters/Chapter11} % Correction factors to the multiplicities
\include{Chapters/Chapter12} % Final charged hadrons multiplicities
\include{Chapters/Chapter13} % Determination of quark fragmentation functions

\cleardoublepage % Empty page before the start of the next part

\include{Chapters/Chapter14} % Summary and Conclusion
...
\include{Chapters/Chapter0A} % Appendix RICH
\include{Chapters/Chapter0B} % Appendix Mult
\include{Chapters/Chapter0C} % Appendix Sys
\include{Chapters/Chapter0D} % Appendix Fit
% \include{Chapters/Chapter0E} % Appendix Direct Extrac
