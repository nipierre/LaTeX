...
\begin{table}[!h]
  ...
  \begin{tabular}{p{10cm} p{2cm} p{2cm}}
    ...
    Events with $0.004 < x < 0.4$ & 83.2 M & 17.5\% \\
    Events with $\nu$ cut & - & - \\
    \hline
    \hline
  \end{tabular}
...
\begin{figure}[!h]
  \subfloat[$Q^2$]{\includegraphics[scale=0.27]{./gfx/Q2DIS.png}}
  \subfloat[$x$]{\includegraphics[scale=0.27]{./gfx/xDIS.png}}
  \subfloat[$y$]{\includegraphics[scale=0.27]{./gfx/yDIS.png}} \\
  \subfloat[$x$-$Q^2$]{\includegraphics[scale=0.27]{./gfx/xQ2.png}}
  \subfloat[$x$-$y$]{\includegraphics[scale=0.23]{./gfx/xy.png}}
