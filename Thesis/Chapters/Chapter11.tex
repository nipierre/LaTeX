...
In the following, $r$ and $g$ refers to 'reconstructed' and 'generated' quantities. The lepton variables are used for both reconstructed and generated samples.
