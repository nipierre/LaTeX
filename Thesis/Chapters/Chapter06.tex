...
\begin{figure}[htb]
\centerline{\epsfig{file=gfx/radgen.png,width=13cm}}
...
\begin{figure}[htb!]
\centerline{\epsfig{file=gfx/elprod.png,width=13cm}}
...
\begin{figure}[htb!]
\centerline{\epsfig{file=gfx/ph_pl.png,width=13cm}}
...
\begin{figure}[htb]
\centerline{\epsfig{file=gfx/DJRAD.png,width=14cm}}
